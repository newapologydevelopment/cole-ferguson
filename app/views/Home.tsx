...
export const Home = ({ projects }: { projects: ProjectType[] }) => {
  ...
  return (
    <div className="h-screen overflow-hidden px-[20px] sm:p-[24px] text-[12px] text-primary-dark">
      ...
      <div
        ref={scrollRef}
        className="absolute inset-0 overflow-y-auto snap-y snap-mandatory scroll-smooth pointer-events-auto"
      >
        {projects.map((project, i) => (
          ...
          >
            {isMobile ? (
              ...
              <Project
                project={project}
                showIndicator={!showAll && i === activeIndex}
              />
            )}

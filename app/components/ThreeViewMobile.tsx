...
export function ThreeViewMobile({ images, objectFit = 'cover', className }: Props) {
    const [a, b, c] = images ?? []
        ...
        <section className={`sm:hidden w-screen h-[100dvh] px-[20px] ${className ?? ''}`}>
            ...
            <div className="grid grid-cols-12 gap-x-[16px] h-full content-center">
                ...
                <div className="col-span-4 min-w-0">
                    <div className="relative w-full overflow-hidden" style={{ aspectRatio: ra }}>
                        {srcA && (
                            <Image
                                src={srcA}
                                alt={a?.alt || ''}
                ...
                {/* B */}
                <div className="col-span-4 min-w-0">
                    <div className="relative w-full overflow-hidden" style={{ aspectRatio: rb }}>
                        {srcB && (
                            <Image
                                src={srcB}
                                alt={b?.alt || ''}
                ...
                {/* C */}
                <div className="col-span-4 min-w-0">
                    <div className="relative w-full overflow-hidden" style={{ aspectRatio: rc }}>
                        {srcC && (
                            <Image
                                src={srcC}
                                alt={c?.alt || ''}

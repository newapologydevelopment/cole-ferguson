...
export const GalleryGridViewMobile = ({
    ...
    // }
    return (
        // <div className={cn("col-start-1 col-span-full h-full pb-[24px]", className)}>
        //     <div className="w-full h-full grid grid-cols-8 gap-x-[20px] gap-y-[20px] content-start items-start auto-rows-max">
        //         {items.map((it, i) => {
        ...
        //     </div>
        // </div>
        <div className="text-[12px] text-primary-dark h-[100dvh] col-span-full flex items-center justify-center" > creating the best mobile user expirience</div>
    )
}
